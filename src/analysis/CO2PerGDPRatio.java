...
public class CO2PerGDPRatio implements Analysis {
	
	private static final String analysisName = "Ratio of CO2 Emissions per GDP (per capita)";
	...
	private String numeratorIndicator = "EN.ATM.CO2E.PC"; // CO2 emissions (metric tons per capita) 	
	private String denominatorIndicator = "NY.GDP.PCAP.CD"; // GDP per capita (current US$) 
	private static String[] methodNames = {"CO2 Emissions", "GDP per Capita"};
