...
public class EducationExpenditureAverage implements Analysis{
	
	private static String analysisName = "Average Government Expenditure On Education, total (% of GDP)";
	private DataFetcher fetcher;
	private String country;
	private String startYear;
	private String endYear;
	private Number[] years;
	private String methodCode = "SE.XPD.TOTL.GD.ZS"; // Government expenditure on education, total (% of GDP) 
	private static String[] methodNames = {"Government Expenditure on Education"};
	...
	private String getDataAsString() {
		...
		reportMessage = "Average government expenditure on education (as % of GDP) \n";
		reportMessage = reportMessage + "For the years " + this.startYear + "-" + this.endYear + " => " + analysisResult[0][0];
		reportMessage = reportMessage + "\n==============================\n";
		reportMessage = reportMessage +  "Average government expenditure for all other purposes (as % of GDP)\n";
