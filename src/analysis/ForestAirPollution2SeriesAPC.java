...
public class ForestAirPollution2SeriesAPC implements Analysis {

	private static final String analysisName = "APC for PM2.5 Air Pollution and Forest Area";
	...
	private String methodCode2 = "AG.LND.FRST.ZS"; // Forest area (% of land area)
	private static String[] methodNames = {"PM2.5 Air Pollution, Mean Annual Exposure", "Forest Area (% of land area)"};
